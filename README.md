...
<li> <a href="https://github.com/IamTechyAnimesh/NubOxint">NubOxint -  Phone number Information Gathering.</a>
  <li><a href="https://github.com/IamTechyAnimesh/GoOsint">GoOsint - OSINT Tool for Gmail Information Gathering.</li>
     <li><a href="https://github.com/IamTechyAnimesh/MSF-Termux-PoC">MSF-Termux-PoC - Installer script for Metasploit Framework on Termux (no root required).</li>
       <li><a href="https://github.com/IamTechyAnimesh/port-scanner">Port-scanner - A fast, multithreaded TCP port scanner with banner grabbing capabilities.</li>
